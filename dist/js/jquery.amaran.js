...
var Amaran = (() => {
  ...
  // src/ts/jquery.amaran.ts
  var jquery_amaran_exports = {};
  var themes = {
  ...
  var AmaranPlugin = class {
    ...
    init() {
      ...
      const themeClass = this.config.themeTemplate ? `amaran ${resolvedContent.themeName ?? ""}`.trim() : `amaran ${this.config.theme}`.trim();
  ...
  return __toCommonJS(jquery_amaran_exports);
})();
//# sourceMappingURL=jquery.amaran.js.map
