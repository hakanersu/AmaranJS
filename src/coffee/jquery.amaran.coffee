...
(($, window, document, undefined_) ->
    ...
    Plugin:: =
       ...
       init: ->
            ...
            amaranObject =
                class: (if (@config.theme) then "amaran " + @config.theme else "amaran")
                html: (if (@config.closeButton) then "<span class=\"amaran-close\"><i class=\"fa fa-times-circle\"></i></span>" + message else message)
    ...
    themes =
        ...
        awesomeTheme: (data) ->
            "<i class=\"icon " + data.icon + " icon-large\"></i><p class=\"bold\">" + data.message + "</p><p><span>" + data.size + "</span><span class=\"light\">" + data.file + "</span></p>"
